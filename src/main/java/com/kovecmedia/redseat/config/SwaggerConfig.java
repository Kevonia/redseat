...
//				.apis(RequestHandlerSelectors.basePackage("com.kovecmedia.redseat.controller"))
...
//		return new ApiInfoBuilder().title("Red Seat Courier")
//				.description("Red Seat Courier")
//				// .contact(new Contact("", "", ""))
//				.license("Apache 2.0")
